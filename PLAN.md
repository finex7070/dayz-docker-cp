...
**Weitere Funktionen:**
- Liste: Name, Workshop-ID, **Typ (Client/Server)**, Größe, Aktualisierungsdatum, **aktiv/inaktiv**, Reihenfolge (Pfeiltasten → bestimmt die Reihenfolge in der jeweiligen Kette)
